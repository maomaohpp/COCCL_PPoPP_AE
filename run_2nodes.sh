...
### hosfile
HOSTFILE_4GPU="hostfile_2nodes_4GPUeach.${JOB_ID}"
...
do
  ...
  host[$k]=$i
  rank[$k]=$(($k-1))
  echo "${host[$k]} slots=4" >> $HOSTFILE_4GPU
done
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------alltoall native 4090-4GPUperNode-GPUs$ng ------------------------------------------------------"
mpirun  -hostfile "${HOSTFILE_4GPU}" \
        -np $ng \
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allgather native 4090-4GPUperNode-GPUs$ng ------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allgather comp 4090-4GPUperNode-GPUs$ng ------------------------------------------------------"
mpirun  -hostfile "${HOSTFILE_4GPU}" \
        -np $ng \
         -x LD_LIBRARY_PATH=$CUDA_PATH/lib64:$NCCL_HOME/lib:$MPI_HOME/lib \
        -x NCCL_DEBUG=WRAN \
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------reducescatter native 4090-4GPUperNode GPU$ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------reducescatter comp ring 4090-4GPUperNode GPU$ng------------------------------------------------------"
...
echo "------------------------------------------------------reducescatter comp oneshot 4090-4GPUperNode GPU$ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------reducescatter comp twoshot 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------reducescatter comp twoshot new 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------reducescatter comp twoshot new 2pipe 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------reducescatter comp twoshot new 4pipe 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------reducescatter comp twoshot new 8pipe 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
echo "------------------------------------------------------reduce scatter comp twoshot overlap p1 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------reduce scatter comp twoshot overlap p2 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allreduce native 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
echo "------------------------------------------------------allreduce comp ring 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allreduce comp oneshot 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allreduce comp twoshot 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allreduce comp tripleshot 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allreduce comp tripleshot new 2pipe 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allreduce comp tripleshot new 4pipe 4090-4GPUperNode GPU $ng------------------------------------------------------"
...
for ((i=0; i<3;i++))
do
echo "------------------------------------------------------allreduce comp tripleshot new 8pipe 4090-4GPUperNode GPU $ng------------------------------------------------------"

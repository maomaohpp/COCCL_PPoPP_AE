...
export NCCL_DEBUG_FILE=/data/home/scyb226/lxc/coccl-training/logs/350M/nccl_logs/ncclcomp.%h.%p
...
OUTPUT_LOG="350M_train_rank${NODE_RANK}_${BATCH_JOB_ID}_3D_dp_s4bit(4bit)_pp_tquant(8bit)_tp_tquant(lossless).log"
...
OUTPUT_ARGS="
    ...
    --wandb-exp-name 350M-GPT_2-acc3D-DP(SDP-w4g4)-PP(TAH-f8b8)-TP(lossless)-32H800 \
"
QUANTIZE_ARGS="

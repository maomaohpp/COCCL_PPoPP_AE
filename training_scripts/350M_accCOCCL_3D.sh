...
OUTPUT_LOG="350M_train_rank${NODE_RANK}_${BATCH_JOB_ID}_3D_dp_s4bit(8bit)_pp_tquant(8bit)_tp_tquant(8bit).log"
...
OUTPUT_ARGS="
    ...
    --wandb-exp-name 350M-GPT_2-acc3D-DP(SDP-8)-PP(TAH-8)-TP(TAH-8)-32H800 \
"
QUANTIZE_ARGS="
